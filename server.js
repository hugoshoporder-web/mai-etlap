/* ===== server.js (FC) =====
   – GA4 MŰKÖDIK (G-92VX8WYT6W)
   – FŐOLDALON VAN LINK + QR
   – F3 = VISSZA FŐOLDALRA (CSAK ASZTALON)
   – DÁTUM: 2026.04.27. -> 2026-04-27
*/
...
app.listen(port, () => console.log("Menu fut – GA OK, link OK, QR OK"));
