...
const fetch = requireyPZUVn4PvNkGlyXdUedMkCWBa0J1f4Eutl9JwMLHBWE/export?format=csv&sheet=ADATOK";const fetch = require("node-fetch");
...
app.listen(port,()=>console.log("Menü szerver fut – végleges stabil verzió"));
