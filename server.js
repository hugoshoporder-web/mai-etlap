...
const { parse } = require("csv-parse/s4PvNkGlyXdUedMkCWBa0J1f4Eutl9JwMLHBWE/export?format=csv&sheet=ADATOK";const { parse } = require("csv-parse/sync");
...
app.listen(port,()=>console.log("Menü szerver fut – QR vonal nélkül, aktuális hét csukva"));
``
